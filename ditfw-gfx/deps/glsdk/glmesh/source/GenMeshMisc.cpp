...
namespace gen
{
	...
	{
    AttributeList attrs;
    attrs.push_back( AttribDesc( ATTR_POS, 2, glmesh::VDT_SIGN_SHORT, glmesh::ADT_NORM_FLOAT ));
		VertexFormat fmt(attrs);
	...
	Mesh * GroundPlane( int numXVerts, int numYVerts, bool bDoubleSided )
	{
		...
		AttributeList attrs;
		attrs.push_back( AttribDesc( ATTR_POS, 2, glmesh::VDT_SIGN_SHORT, glmesh::ADT_NORM_FLOAT ));
		attrs.push_back( AttribDesc( ATTR_NORMAL, 4, glmesh::VDT_SIGN_BYTE, glmesh::ADT_NORM_FLOAT ));
		attrs.push_back( AttribDesc(  ATTR_TEXCOORD, 2, glmesh::VDT_UNSIGN_SHORT, glmesh::ADT_NORM_FLOAT ));
	...
	Mesh * Axes( ColorArray colorSequence )
	{
		...
		AttributeList attrs;
    attrs.push_back( AttribDesc( ATTR_POS, 3, glmesh::VDT_SIGN_SHORT, glmesh::ADT_NORM_FLOAT ));
		attrs.push_back( AttribDesc( ATTR_COLOR, 4, glmesh::VDT_UNSIGN_BYTE, glmesh::ADT_NORM_FLOAT ));
	...
	Mesh * CubeBlock( int numCubesOnEdge, const ColorArray &colorSequence )
	{
		...
		if (!colorSequence.empty())
		{
			attrs.push_back( AttribDesc( ATTR_POS, 3, glmesh::VDT_SIGN_SHORT, glmesh::ADT_FLOAT ));
			attrs.push_back( AttribDesc( ATTR_NORMAL, 4, glmesh::VDT_SIGN_BYTE, glmesh::ADT_NORM_FLOAT ));
			attrs.push_back( AttribDesc( ATTR_COLOR, 4, glmesh::VDT_UNSIGN_BYTE, glmesh::ADT_NORM_FLOAT ));
		}
		else
