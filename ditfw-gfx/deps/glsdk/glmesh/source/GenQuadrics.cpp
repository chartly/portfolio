...
namespace glmesh
{
	namespace gen
	{
      ...
      AttributeList attrs;
      attrs.push_back( AttribDesc( ATTR_POS     , 3, glmesh::VDT_SINGLE_FLOAT, glmesh::ADT_FLOAT));
		  attrs.push_back( AttribDesc( ATTR_NORMAL  , 3, glmesh::VDT_SINGLE_FLOAT, glmesh::ADT_FLOAT));
      attrs.push_back( AttribDesc( ATTR_TEXCOORD, 2, glmesh::VDT_SINGLE_FLOAT, glmesh::ADT_FLOAT));
